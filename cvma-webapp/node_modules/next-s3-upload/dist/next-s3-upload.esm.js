...
var useS3Upload = function useS3Upload(options) {
  ...
  var uploadToS3 = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(file, options) {
      var _options$endpoint$req, _options, _options$endpoint2;

      var filename, requestExtras, body, headers, res, data, _uploadResult$Locatio, _uploadResult$Bucket, _uploadResult$Key, client, params, s3Upload, uploadResult;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 23:
              ...
              return _context.abrupt("return", {
                url: (_uploadResult$Locatio = uploadResult.Location) != null ? _uploadResult$Locatio : '',
