...
(() => {
var exports = {};
exports.id = "pages/api/document/s3-delete";
exports.ids = ["pages/api/document/s3-delete"];
exports.modules = {
...
/***/ "(api)/./pages/api/document/s3-delete.js":
/*!*****************************************!*\
  !*** ./pages/api/document/s3-delete.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _aws_sdk_client_s3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @aws-sdk/client-s3 */ \"@aws-sdk/client-s3\");\n/* harmony import */ var _aws_sdk_client_s3__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_aws_sdk_client_s3__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _helpers_api_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../helpers/api-util */ \"(api)/./helpers/api-util.js\");\n/* harmony import */ var _helpers_db_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../helpers/db-util */ \"(api)/./helpers/db-util.js\");\n\n\n\n//https://combatveteransmotorcycleassocaition.s3.amazonaws.com/next-s3-uploads/284bbc12-94f1-44f7-b704-0e3eb941d6dc/years.js\nasync function handler(req, res) {\n    if (req.method == \"DELETE\") {\n        const location = req.body.location;\n        const bucket = \"combatveteransmotorcycleassocaition\";\n        const key = location.slice(71);\n        const bucketParams = {\n            Bucket: bucket,\n            Key: key\n        };\n        await _helpers_api_util__WEBPACK_IMPORTED_MODULE_1__.s3Client.send(new _aws_sdk_client_s3__WEBPACK_IMPORTED_MODULE_0__.DeleteObjectCommand(bucketParams));\n        const client = await (0,_helpers_db_util__WEBPACK_IMPORTED_MODULE_2__.connectDatabase)();\n        const collection = client.db().collection(\"documents\");\n        await collection.deleteOne({\n            location: location\n        });\n        res.status(200).json({\n            message: \"DELETED, Please Refresh\"\n        });\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handler);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/document/s3-delete.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/document/s3-delete.js"));
